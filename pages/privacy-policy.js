  ...
  return (
    <div>
      <h1 className="py-8 text-center text-2xl font-bold">
        Privacy Policy for Co Tam Restaurant
      </h1>
      <p className="px-8 ">
        At Co Tam Restaurant, accessible from https://cotam.nl, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by Co Tam
        Restaurant and how we use it. If you have additional questions or
        ...
        that they shared and/or collect in Co Tam Restaurant. This policy is not
        ...
        <h2 className="py-2 text-xl font-bold">Consent</h2>
        By using our website, you hereby consent to our Privacy Policy and agree
        to its terms. For our Terms and Conditions, please visit the Terms &
        Conditions Generator.
        <h2 className="py-2 text-xl font-bold">Information we collect</h2> The
        ...
        <h2 className="py-2 text-xl font-bold">How we use your information </h2>
        ...
        you emails Find and prevent fraud Log Files Co Tam Restaurant follows a
        ...
        other website, Co Tam Restaurant uses 'cookies'. These cookies are used
        ...
        more general information on cookies, please read "What Are Cookies" from
        Cookie Consent. Advertising Partners Privacy Policies You may consult
        this list to find the Privacy Policy for each of the advertising
        partners of Co Tam Restaurant. Third-party ad servers or ad networks
        uses technologies like cookies, JavaScript, or Web Beacons that are used
        in their respective advertisements and links that appear on Co Tam
        Restaurant, which are sent directly to users' browser. They
        ...
        websites that you visit. Note that Co Tam Restaurant has no access to or
        control over these cookies that are used by third-party advertisers.
        Third Party Privacy Policies Co Tam Restaurant's Privacy Policy does not
        ...
        guide their online activity. Co Tam Restaurant does not knowingly
